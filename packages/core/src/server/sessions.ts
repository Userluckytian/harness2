...
import { type HubDelivery, type HubEntry, UNDO_MAX_N, isTaskState } from './sessions-core.js';
...
export class SessionHub extends SessionHubAssembly implements ResumeStateProvider {
  // —— turn 流转 ——
